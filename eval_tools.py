...
TUNED = [
    ...
    ("launch Slack", "open_app", None), ("play the music", "playback", None),
    ("pause", "playback", None), ("next song", "playback", None),
    ("skip this track", "playback", None),
    ("go back to the previous song", "playback", None),
...
HELDOUT = [
    ...
    ("stop the music", "playback", {"action": "pause"}),
    ("resume the song", "playback", {"action": "play"}),
    ("play the next one", "playback", {"action": "next"}),
    ("previous track please", "playback", {"action": "previous"}),
